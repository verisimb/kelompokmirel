...
@section('page-title', 'Tambah Alternatif (E-Wallet)')

@section('content')
<div class="card border-0 shadow-sm" style="border-radius: 16px;">
    <div class="card-body">
        <h5 class="card-title fw-semibold" style="color: #1e293b;">➕ Tambah E-Wallet Baru</h5>
        <hr>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('kode_alternatif') is-invalid @enderror" 
                           id="kode_alternatif" name="kode_alternatif" value="{{ old('kode_alternatif') }}" 
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('nama_ewallet') is-invalid @enderror" 
                           id="nama_ewallet" name="nama_ewallet" value="{{ old('nama_ewallet') }}" 
